local utils = require("keystone.tasks.validate.validatorutils")

local M = {}

---@class keystone.tasks.TomlParseResult
---@field ok boolean
---@field data table|nil
---@field pointer_map table<string, keystone.tasks.Range4>
---@field syntax_errors keystone.tasks.TomlSyntaxError[]
---@field err string|nil

---@class keystone.tasks.TomlSyntaxError
---@field message string
---@field range keystone.tasks.Range4

---@alias keystone.tasks.Range4 { [1]: integer, [2]: integer, [3]: integer, [4]: integer }

---@param node TSNode
---@return keystone.tasks.Range4
...
---@param pointer_map table<string, keystone.tasks.Range4>
---@param path string[]
---@return any
...
---@param node TSNode
---@param out keystone.tasks.TomlSyntaxError[]
...
---@param bufnr integer
---@return keystone.tasks.TomlParseResult
