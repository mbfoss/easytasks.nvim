...
---@param name string?
---@return (fun(line: string): tomltasks.QfItem?)?, string?
...
---@class tomltasks.ProcessTask : tomltasks.TaskBase
...
---@type tomltasks.TaskTypeDef & { register_qfmatcher: fun(name: string, fn: tomltasks.QfMatcher) }
local M = {
    register_qfmatcher = qfmatchers.register,

    ---@type tomltasks.RunFn
    start = function(task, ctx, on_done)
        ---@cast task tomltasks.ProcessTask
